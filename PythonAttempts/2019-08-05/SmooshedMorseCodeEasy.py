#For the purpose of this challenge, Morse code
# represents every letter as a sequence of 1-4
# characters, each of which is either . (dot)
# or -(dash). The code for the letter a is .-,
# for b is -..., etc. The codes for each letter
# a through z are:
# .- -... -.-. -.. . ..-. --. .... .. .--- -.- .-.. -- -. --- .--. --.- .-. ... - ..- ...- .-- -..- -.-- --..
# Normally, you would indicate where one letter
# ends and the next begins, for instance with a
# space between the letters' codes, but for this
# challenge, just smoosh all the coded letters
# together into a single string consisting of only
# dashes and dots.
